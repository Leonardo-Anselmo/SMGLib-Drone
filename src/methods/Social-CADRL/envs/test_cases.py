...
def get_testcase_two_agents(policies=["learning", "GA3C_CADRL", "CADRL"]):
    goal_x = 9
    goal_y = 6
    agents = [
        Agent(
...
def get_doorway(policies=["learning", "GA3C_CADRL", "CADRL"]):
    agents = [
        Agent(
            -3.0,
            0.0,
        ...
        # Vertical wall obstacles - bottom side
        Agent(
            0.0,
            -9.0,
            0.0,
       ...
       Agent(
        ...
        # Vertical wall obstacles - top side
        Agent(
            0.0,
            2.0,
            0.0,
...
def get_doorway_nominal(policies=["learning", "GA3C_CADRL", "CADRL"]):
    agents = [
        Agent(
            -3.0,
            0.0,
...
def get_hallway(policies=["learning", "GA3C_CADRL", "CADRL"]):
    goal_x = 3.0
    goal_y = 0.0
    agents = [
        Agent(
...
def get_hallway_nominal(policies=["learning", "GA3C_CADRL", "CADRL"]):
    goal_x = 3.0
    goal_y = 0.0
    agents = [
        Agent(
...
def get_intersection(policies=["learning", "GA3C_CADRL", "CADRL"]):
    goal_x = 5.0
    goal_y = 0.0
    agents = [
        # Dynamic agent 1 - controlled externally
        Agent(
            -3.0,
            0.0,
            goal_x,
        ...
        # Static obstacles around the intersection
        Agent(
            -3.0,
            2.0,
            -3.0,
...
def get_intersection_nominal(policies=["learning", "GA3C_CADRL", "CADRL"]):
    goal_x = 5.0
    goal_y = 0.0
    agents = [
