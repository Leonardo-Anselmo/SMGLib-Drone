#!/usr/bin/env python3
"""
Comprehensive Test Suite for Social Collision Avoidance Scenarios

This script runs 10 different test cases covering:
- All 3 scenarios (intersection, hallway, doorway)
- Various numbers of agents (1-4)
...
def run_test_case(test_name, cmd_args, expected_agents=None):
    ...
    try:
        # Run the command - cmd_args already properly formatted as list
...
def create_test_agent_files():
    ...
    # Test case 6: Complex intersection with 3 agents
    agents_3_intersection = {
        "agents": [
            {"start_x": -3, "start_y": 0, "goal_x": 5, "goal_y": 0, "radius": 0.5, "pref_speed": 1.0, "heading": 0},
            {"start_x": 0, "start_y": -3, "goal_x": 0, "goal_y": 5, "radius": 0.4, "pref_speed": 1.2, "heading": 1.57},
            {"start_x": 3, "start_y": 2, "goal_x": -5, "goal_y": -2, "radius": 0.6, "pref_speed": 0.8, "heading": 3.14}
        ]
    }
    ...
    # Test case 10: Multi-agent doorway challenge
    agents_4_doorway = {
        "agents": [
            {"start_x": -6, "start_y": 0.2, "goal_x": 6, "goal_y": 0.2, "radius": 0.3, "pref_speed": 0.8, "heading": 0},
            {"start_x": -5.5, "start_y": -0.2, "goal_x": 5.5, "goal_y": -0.2, "radius": 0.3, "pref_speed": 0.9, "heading": 0},
            {"start_x": 6, "start_y": 0.1, "goal_x": -6, "goal_y": 0.1, "radius": 0.25, "pref_speed": 1.1, "heading": 3.14},
            {"start_x": 5.5, "start_y": -0.1, "goal_x": -5.5, "goal_y": -0.1, "radius": 0.25, "pref_speed": 1.0, "heading": 3.14}
        ]
    }
...
def main():
    """Run all test cases"""
    print("🚀 Starting Comprehensive Social Collision Avoidance Test Suite")
    ...
    test_cases = [
        ...
        # Test Case 4: Intersection with 4 agents from corners
        {
            ...
            "args": [
                ...
                "--agent1", "-4,0:4,0:0.4:1.0:0",      # East to West
                "--agent2", "4,0:-4,0:0.4:1.0:3.14",   # West to East
                "--agent3", "0,-4:0,4:0.4:1.0:1.57",   # South to North
                "--agent4", "0,4:0,-4:0.4:1.0:4.71"    # North to South
            ],
            "expected_agents": 4
        },
        ...
        # Test Case 5: Intersection with diagonal movements
        {
            ...
            "args": [
                "--scenario", "intersection", "--agents", "3", "--quiet",
                "--agent1", "-3,-3:3,3:0.4:1.0:0.785",    # Diagonal SW to NE
                "--agent2", "3,-3:-3,3:0.4:1.0:2.356",    # Diagonal SE to NW
                "--agent3", "0,-4:0,4:0.4:1.0:1.57"       # Straight vertical
            ],
            "expected_agents": 3
        },
        ...
        # Test Case 7: Intersection with close encounters
        {
            ...
            "args": [
                "--scenario", "intersection", "--agents", "2", "--quiet",
                "--agent1", "-2,0.2:2,0.2:0.3:0.8:0",
                "--agent2", "-2,-0.2:2,-0.2:0.3:0.8:0"
            ],
            "expected_agents": 2
        },
        ...
        # Test Case 8: Intersection with mixed sizes
        {
            ...
            "args": [
                "--scenario", "intersection", "--agents", "3", "--quiet",
                "--agent1", "-3,0:5,0:0.2:1.2:0",      # Very small, fast
                "--agent2", "2,-5:5,0:0.8:0.6:1.57",   # Very large, slow
                "--agent3", "-1,2:1,-2:0.5:1.0:4.71"   # Medium
            ],
            "expected_agents": 3
        },
        ...
        # Test Case 9: Intersection with asymmetric goals
        {
            ...
            "args": [
                "--scenario", "intersection", "--agents", "3", "--quiet",
                "--agent1", "-4,0:2,3:0.4:1.0:0",
                "--agent2", "0,-4:3,-1:0.4:1.0:1.57",
                "--agent3", "4,1:-2,-2:0.4:1.0:3.14"
            ],
            "expected_agents": 3
        },
        ...
        # Test Case 10: Intersection stress test
        {
            ...
            "args": [
                ...
                "--agent1", "-3,0:5,0:0.3:1.0:0",
                "--agent2", "2,-5:5,0:0.3:1.0:1.57",
                "--agent3", "-1,3:1,-3:0.3:1.0:4.71",
                "--agent4", "-5,1:4,-1:0.3:1.0:0.2",
                "--agent5", "1,-3:-1,4:0.3:1.0:2.0"
            ],
            "expected_agents": 5
        },
        ...
        # Test Case 12: Opposing agents
        {
            ...
            "args": [
                ...
                "--agent1", "-3,0.3:3,0.3:0.4:1.0:0",
                "--agent2", "3,-0.3:-3,-0.3:0.4:1.0:3.14"
            ],
            "expected_agents": 2
        },
        ...
        # Test Case 13: Multi-agent congestion
        {
            ...
            "args": [
                ...
                "--agent1", "-3,0.5:3,0.5:0.3:0.9:0",
                "--agent2", "-2.5,0:2.5,0:0.3:1.1:0", 
                "--agent3", "-3,-0.5:3,-0.5:0.3:0.8:0"
            ],
            "expected_agents": 3
        },
        ...
        # Test Case 14: Speed differential test
        {
            ...
            "args": [
                "--scenario", "hallway", "--agents", "3", "--quiet",
                "--agent1", "-4,0.2:4,0.2:0.3:2.0:0",   # Very fast
                "--agent2", "-3.5,0:3.5,0:0.4:0.7:0",   # Slow
                "--agent3", "-3.8,-0.2:3.8,-0.2:0.3:1.3:0"  # Medium-fast
            ],
            "expected_agents": 3
        },
        ...
        # Test Case 15: Large agent in narrow space
        {
            ...
            "args": [
                "--scenario", "hallway", "--agents", "2", "--quiet",
                "--agent1", "-3,0:3,0:0.6:0.8:0",       # Large, slow
                "--agent2", "3,0.3:-3,0.3:0.2:1.2:3.14"  # Small, fast, opposite
            ],
            "expected_agents": 2
        },
        ...
        # Test Case 16: Multiple following agents
        {
            ...
            "args": [
                ...
                "--agent1", "-4,0.3:4,0.3:0.3:1.0:0",
                "--agent2", "-3.5,0.3:3.5,0.3:0.3:1.0:0",
                "--agent3", "-3,0.3:3,0.3:0.3:1.0:0",
                "--agent4", "-2.5,0.3:2.5,0.3:0.3:1.0:0"
            ],
            "expected_agents": 4
        },
        ...
        # Test Case 17: Overtaking scenario
        {
            ...
            "args": [
                "--scenario", "hallway", "--agents", "3", "--quiet",
                "--agent1", "-4,0:4,0:0.4:0.6:0",       # Slow leader
                "--agent2", "-3.5,0.2:3.5,0.2:0.3:1.4:0",  # Fast follower
                "--agent3", "3.5,-0.2:-3.5,-0.2:0.3:1.0:3.14"  # Oncoming
            ],
            "expected_agents": 3
        },
        ...
        # Test Case 18: Mixed direction flow
        {
            ...
            "args": [
                "--scenario", "hallway", "--agents", "4", "--quiet",
                "--agent1", "-3.5,0.4:3.5,0.4:0.3:1.0:0",
                "--agent2", "-3,0.1:3,0.1:0.3:1.0:0",
                "--agent3", "3.5,-0.1:-3.5,-0.1:0.3:1.0:3.14",
                "--agent4", "3,-0.4:-3,-0.4:0.3:1.0:3.14"
            ],
            "expected_agents": 4
        },
        ...
        # Test Case 20: Angled approaches
        {
            ...
            "args": [
                ...
                "--agent1", "-5,1:5,-1:0.4:1.0:0",
                "--agent2", "-4,-1:4,1:0.4:1.0:0",
                "--agent3", "5,0.5:-5,-0.5:0.4:1.0:3.14"
            ],
            "expected_agents": 3
        },
        ...
        # Test Case 21: Small agents through doorway
        {
            ...
            "args": [
                ...
                "--agent1", "-6,0.3:6,0.3:0.2:1.2:0",
                "--agent2", "-5.5,0:5.5,0:0.2:1.3:0",
                "--agent3", "-6,-0.3:6,-0.3:0.2:1.1:0",
                "--agent4", "6,0.1:-6,0.1:0.2:1.0:3.14"
            ],
            "expected_agents": 4
        },
        ...
        # Test Case 22: Large agent priority
        {
            ...
            "args": [
                "--scenario", "doorway", "--agents", "3", "--quiet",
                "--agent1", "-6,0:6,0:0.7:0.6:0",      # Large, slow
                "--agent2", "-5.5,0.4:5.5,0.4:0.2:1.2:0",  # Small, fast
                "--agent3", "6,0.2:-6,0.2:0.3:1.0:3.14"    # Medium, opposite
            ],
            "expected_agents": 3
        },
        ...
        # Test Case 24: Simultaneous arrival
        {
            ...
            "args": [
                "--scenario", "doorway", "--agents", "4", "--quiet",
                "--agent1", "-6,0.2:6,0.2:0.3:1.0:0",
                "--agent2", "-6,-0.2:6,-0.2:0.3:1.0:0",
                "--agent3", "6,0.2:-6,0.2:0.3:1.0:3.14",
                "--agent4", "6,-0.2:-6,-0.2:0.3:1.0:3.14"
            ],
            "expected_agents": 4
        },
        ...
        # Test Case 25: Extreme doorway challenge
        {
            ...
            "args": [
                ...
                "--agent1", "-7,0.4:7,0.4:0.25:1.5:0",
                "--agent2", "-6.5,0.1:6.5,0.1:0.25:1.3:0",
                "--agent3", "-6,-0.2:6,-0.2:0.25:1.4:0",
                "--agent4", "7,-0.4:-7,-0.4:0.25:1.2:3.14",
                "--agent5", "6.5,-0.1:-6.5,-0.1:0.25:1.1:3.14",
                "--agent6", "6,0.2:-6,0.2:0.25:1.0:3.14"
            ],
            "expected_agents": 6
        }
    ]
